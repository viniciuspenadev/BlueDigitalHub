...
$page_t = [
    'pt' => [
        ...
        'fin_title' => 'Financeiro Integrado',
        'fin_subtitle' => 'Automatize cobranças e elimine a inadimplência com nosso ecossistema completo.',
        'fin_feat_1' => 'Gateway Asaas',
        'fin_feat_1_desc' => 'Boletos e Pix automáticos',
        'fin_feat_2' => 'Régua de Cobrança',
        'fin_feat_2_desc' => 'Lembretes inteligentes',
        'fin_feat_3' => 'App dos Pais',
        'fin_feat_3_desc' => 'Pagamento em 1 clique',
        'fin_feat_4' => 'Baixa Automática',
        'fin_feat_4_desc' => 'Zero conciliação manual',
        'fin_ben_1' => 'Fim da Inadimplência',
        'fin_ben_2' => 'Economia de Tempo',
        'fin_ben_3' => 'Gestão Profissional',
    ],
    'en' => [
        ...
        // Financial Section (New)
        'fin_title' => 'Integrated Finance',
        'fin_subtitle' => 'Automate billing and eliminate delinquency with our complete ecosystem.',
        'fin_feat_1' => 'Payment Gateway',
        'fin_feat_1_desc' => 'Auto Bank Slips & Pix',
        'fin_feat_2' => 'Smart Reminders',
        'fin_feat_2_desc' => 'Automated follow-ups',
        'fin_feat_3' => 'Parent App',
        'fin_feat_3_desc' => '1-Click Payment',
        'fin_feat_4' => 'Auto Reconciliation',
        'fin_feat_4_desc' => 'No manual work',
        'fin_ben_1' => 'Zero Delinquency',
        'fin_ben_2' => 'Time Saving',
        'fin_ben_3' => 'Professional Mgmt',
    ],
    'es' => [
        ...
        // Financial Section (New)
        'fin_title' => 'Finanzas Integradas',
        'fin_subtitle' => 'Automatice cobros y elimine la morosidad con nuestro ecosistema completo.',
        'fin_feat_1' => 'Pasarela de Pago',
        'fin_feat_1_desc' => 'Boletos y Pix automáticos',
        'fin_feat_2' => 'Recordatorios',
        'fin_feat_2_desc' => 'Seguimiento inteligente',
        'fin_feat_3' => 'App para Padres',
        'fin_feat_3_desc' => 'Pago en 1 clic',
        'fin_feat_4' => 'Conciliación Auto',
        'fin_feat_4_desc' => 'Cero trabajo manual',
        'fin_ben_1' => 'Fin de la Morosidad',
        'fin_ben_2' => 'Ahorro de Tiempo',
        'fin_ben_3' => 'Gestión Profesional',
    ]
];
